...
function Hero() {
  return (
    <div className='flex flex-col justify-center items-center my-20'>
        ...
        <h2 className='font-bold text-[60px] text-slate-700'>Easy scheduling</h2>
        <h2 className='text-xl mt-5 text-slate-500'>Scheduly offers an automated scheduling platform designed to streamline the process of finding the ideal meeting time, while also providing additional functionalities.</h2>
